...
function navigateTo(page) {
    ...
    switch(page) {
        case 'home':
            ...
            <p>Get your own QR codes easily for any URL or text. Navigate to the MyQRCode section to start generating your QR codes instantly.</p>
        ...
        case 'about':
            ...
            <p>To provide accessible and user-friendly QR generation tools for everyone.</p>
        </section>
        <section class="about-section">
            <h2>Our Vision</h2>
            <p>To be the leading QR solution provider, enhancing connectivity and engagement in the digital age.</p>
        </section>
        <section class="about-section">
            <h2>Meet the Team</h2>
